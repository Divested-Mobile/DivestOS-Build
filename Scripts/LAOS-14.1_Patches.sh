...
sed -i 's/Global.ENABLE_EPHEMERAL_FEATURE, 1/Global.ENABLE_EPHEMERAL_FEATURE, 0/' src/com/android/settings/applications/ManageDomainUrls.java; #Disable "Instant Apps"
