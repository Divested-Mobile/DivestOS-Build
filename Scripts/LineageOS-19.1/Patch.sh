...
git fetch https://github.com/LineageOS/android_packages_modules_DnsResolver refs/changes/09/373909/1 && git cherry-pick FETCH_HEAD; #S_asb_2023-11
...
git fetch https://github.com/LineageOS/android_packages_modules_StatsD refs/changes/10/373910/1 && git cherry-pick FETCH_HEAD; #S_asb_2023-11
fi;
