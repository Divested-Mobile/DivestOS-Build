...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2020-8428/4.14/0004.patch
...
git apply $DOS_PATCHES_LINUX_CVES/CVE-2020-10690/4.14/0003.patch
...
editKernelLocalversion "-dos.p258"
cd "$DOS_BUILD_BASE"
