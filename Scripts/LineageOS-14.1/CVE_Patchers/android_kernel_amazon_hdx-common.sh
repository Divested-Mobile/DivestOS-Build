...
git apply --3way $cvePatches/CVE-2012-6704/ANY/0.patch
...
git apply --3way $cvePatches/CVE-2014-7822/3.2-^3.16/0.patch
...
git apply --3way $cvePatches/CVE-2014-9866/ANY/0.patch
