...
git apply --3way $cvePatches/CVE-2016-8401/ANY/0.patch
...
git apply --3way $cvePatches/CVE-2016-8454/ANY/0.patch
git apply --3way $cvePatches/CVE-2016-8455/ANY/0.patch
git apply --3way $cvePatches/CVE-2016-8464/3.10/0.patch
git apply --3way $cvePatches/CVE-2016-8466/3.10/0.patch
git apply --3way $cvePatches/CVE-2016-8473/3.10/0.patch
git apply --3way $cvePatches/CVE-2016-8474/3.10/0.patch
...
git apply --3way $cvePatches/CVE-2017-0571/3.10/0.patch
git apply --3way $cvePatches/CVE-2017-0574/ANY/0.patch
...
git apply --3way $cvePatches/CVE-2017-0633/ANY/0.patch
...
git apply --3way $cvePatches/CVE-2017-0787/ANY/0.patch
git apply --3way $cvePatches/CVE-2017-0788/ANY/0.patch
git apply --3way $cvePatches/CVE-2017-0789/ANY/0.patch
git apply --3way $cvePatches/CVE-2017-0790/ANY/0.patch
git apply --3way $cvePatches/CVE-2017-0791/ANY/0.patch
git apply --3way $cvePatches/CVE-2017-0792/ANY/0.patch
git apply --3way $cvePatches/CVE-2017-0825/3.10/0.patch
